...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-default  navbar-fixed-top" style="background-color: #26A599;">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" style="color: #fff" href="#">Logo</a>
        </div>
        ...
        <div class="container chamada-banner">
          <div class="row">
              <div class="col-md-12 text-center">
                  <h2><?php echo htmlentities('<'); ?><?php echo htmlentities('>');  ?></h2>
